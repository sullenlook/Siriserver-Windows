...
class time(Plugin):
    ...
    localizations = {"currentTime": 
                        {"search":{"de-DE": "Er wordt gezocht ...", "en-US": "Looking up ..."}, 
                         "currentTime": {"de-DE": "Het is @{fn#currentTime}", "en-US": "It is @{fn#currentTime}"}}, 
                     "currentTimeIn": 
                        {"search":{"de-DE": "Er wordt gezocht ...", "en-US": "Looking up ..."}, 
                         "currentTimeIn": 
                                {
                                "tts": {"de-DE": u"De tijd in {0},{1} is @{{fn#currentTimeIn#{2}}}:", "en-US": "The time in {0},{1} is @{{fn#currentTimeIn#{2}}}:"},
                                "text": {"de-DE": u"De tijd in {0}, {1} is @{{fn#currentTimeIn#{2}}}:", "en-US": "The time in {0}, {1} is @{{fn#currentTimeIn#{2}}}:"}
                                }
                        },
                    "failure": {
                                "de-DE": "Ik kan je de klok nu niet laten zien", "en-US": "I cannot show you the clock right now"
                                }
                    }

    @register("de-DE", "(Hoe laat.*)|(.*tijd*)")     
    ...
    @register("de-DE", "(Hoe laat.*in [a-z]+)|(tijd.*in [a-z]+)")

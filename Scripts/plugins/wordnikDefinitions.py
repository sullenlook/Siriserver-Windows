...
wordnik_api_key = "735be23541b2a5469f00f04dc780fdb610b95afe7d5d6bbe5" # PUT YOUR API KEY HERE in " "
       ...
       if language == "de-DE":
           ...
           if len(output) == 1:
               ...
               if u'text' in answer:
                   ...
                   if worddef:
                       self.say(worddef, "De betekenis van {0} is: {1}".format(Question, worddef))
                   else:
                       self.say("Sorry, ik kon " + Question + " niet in het woordenboek vinden.")
           else:

...
webSearchAnswerText = {"de": u"Op het web zoeken naar {0}...", "en": u"Searching the web for {0} …", "fr": u"Searching the web for {0} …"}
webSearchAnswerFailureText = {"de": u"Sorry, ik kan het web nu niet doorzoeken", "en": u"Sorry but I cannot search the web right now.", "fr": u"Sorry but I cannot search the web right now."}

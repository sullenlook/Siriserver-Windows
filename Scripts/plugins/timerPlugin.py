        ...
        'Timer': {
            'durationTooBig': {
               'en-US': 'Sorry, I can only set timers up to 24 hours.'
                ...
                'de-DE': 'Sorry, Ik kan maar tot 24 uur.'
            }, "settingTimer": {
                "de-DE": u"De timer aan het instellen op\u2026"
            }, 'showTheTimer': {
                'de-DE': u'Hier\u2019s de timer:'
            }, 'timerIsAlreadyPaused': {
                'de-DE': u'Hij\u2019s al gepauzeerd.'
            }, "timerIsAlreadyRunning": {
                "de-DE": u"De timer\u2019s staat al aan:"
            }, 'timerIsAlreadyStopped': {
                'de-DE': u'Hij\u2019s is al gestopt.'
            }, 'timerWasPaused': {
                'de-DE': u'Het\u2019s gepauzeerd.'
            }, 'timerWasReset': {
                'de-DE': u'Ik\u2019ve heb de timer laten vervallen.'
            }, 'timerWasResumed': {
                'de-DE': u'Hij\u2019s is weer doorgegaan.'
            }, "timerWasSet": {
                "de-DE": "Je timer staat ingesteld voor {0}."
            }, "wontSetTimer": {
                "de-DE": "OK."
            }
        }
